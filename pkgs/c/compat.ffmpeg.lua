...
-- with zero configure/make. Auto-generated — do not edit by hand.
-- Regenerate: tools/compat-ffmpeg/{fetch_upstream.sh,gen_config.sh,
-- gen_descriptor.py} per OS, then tools/compat-gen/restructure.py (hoists
...
package = {
    ...
    mcpp = {
        ...
        -- sources common to every shipped OS (hoisted by tools/compat-gen/restructure.py;
        -- per-OS sections below are additive overlays holding only their delta)
        sources = {
            "*/libavcodec/012v.c",
            "*/libavcodec/4xm.c",
            "*/libavcodec/8bps.c",
        ...
        linux = {
            ...
            -- linux-only delta (common sources are hoisted to the top-level `sources`; per-OS sections are additive overlays)
            sources = {
                "*/-Pconfig.asm",
...
%define CONFIG_IPNS_GATEWAY_PROTOCOL 0
        ...
        macosx = {
            ...
            -- macosx-only delta (common sources are hoisted to the top-level `sources`; per-OS sections are additive overlays)
            sources = {
